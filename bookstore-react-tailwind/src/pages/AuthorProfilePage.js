...
const AuthorProfilePage = () => {
  ...
  if (!author) {
    return <div className="p-4 text-center text-gray-700">No author details found.</div>;
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white shadow-lg rounded-lg flex flex-col md:flex-row">
      ...
      <div className="md:w-2/3 md:pl-6">
        <h1 className="text-3xl font-semibold mb-4 text-gray-800">{author.name}</h1>
        <p className="text-base text-gray-700 mb-4">
          <strong>Biography:</strong> {author.biography || "This author biography is not available."}
        </p>
        <p className="text-base text-gray-700 mb-2"><strong>Date of Birth:</strong> {author.date_of_birth}</p>
